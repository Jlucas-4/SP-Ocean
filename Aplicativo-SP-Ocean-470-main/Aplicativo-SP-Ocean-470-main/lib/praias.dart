...
class PrumirimPage extends StatefulWidget {
  const PrumirimPage({super.key});
...
class _SPOceanHomePageState extends State<PrumirimPage> {
...
List<Praia> pra = [
  ...
  Praia(
      ...
      imgInicial: 'assets/img/Prumirim.jpg'),
  Praia(
